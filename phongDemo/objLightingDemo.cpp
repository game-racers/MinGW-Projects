...
\******************************************************************************/
//g++ -o objLightingDemo gl_utils.cpp math_funcs.cpp objLightingDemo.cpp libglfw3dll.a libglew32.dll.a -I include -lglew32 -lglfw3 -lgdi32 -lopengl32
...
int main () {
	...
	GLuint shader_programme = create_programme_from_files (
		"vs_light.glsl", "fs_phongLight_fillIn.glsl");
